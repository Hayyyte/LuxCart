      ...
      <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 w-full my-2 bg-slate-300 rounded-3xl" id="new_arrivals">
            ...
            <div className="m-5 p-5 bg-slate-500 rounded-2xl">
              ...
              <br />
              <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolore fugiat quo est animi consequuntur tempora sunt nihil dolor alias assumenda sed fugit voluptas quibusdam neque dolores corporis, architecto illum impedit mollitia nobis, vitae qui, molestias exercitationem. Commodi ullam, nisi consectetur similique hic saepe veniam ex, nam possimus fugiat velit officia.
              </p>
              <br />
